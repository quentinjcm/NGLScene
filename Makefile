#############################################################################
# Makefile for building: FirstScene
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  FistScene.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile FistScene.pro
#############################################################################
...
INCPATH       = -I. -Iinclude -I../../NGL/include -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtOpenGL -I/opt/qt/5.5/gcc_64/include/QtWidgets -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore -Imoc -I/opt/qt/5.5/gcc_64/mkspecs/linux-clang
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = FirstScene1.0.0
DISTDIR = /home/i7624405/CA1/FirstScene/obj/FirstScene1.0.0
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -Wl,-rpath,/opt/qt/5.5/gcc_64 -Wl,-rpath,/home/i7624405/NGL/lib -Wl,-rpath,/opt/qt/5.5/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -L/home/i7624405/NGL/lib -l NGL -ltiff -L/opt/qt/5.5/gcc_64/lib -lQt5OpenGL -L/usr/lib64 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		FistScene.pro include/NGLScene.h src/main.cpp \
		src/NGLScene.cpp
QMAKE_TARGET  = FirstScene
...
Makefile: FistScene.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/qt/5.5/gcc_64/mkspecs/common/unix.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/linux.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/sanitize.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile FistScene.pro
